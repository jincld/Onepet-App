...
import javax.mail.internet.MimeMessage
    ...
    suspend fun enviarcorreolog (receptor: String, sujeto: String, mensaje: String) = withContext(
        Dispatchers.IO) {
...
<body>
    <div class='container'>
        ...
        <div class='content'>
            <h2>Alerta de seguridad OnePet!</h2>
            <p>Hola,</p>
            <p>Se inicio sesion en tu cuenta de OnePet! </p>
            <div class='code-container'>
                <div class='code'>$mensaje</div>
            </div>
            <p>Por favor, si no eres tu, te recomendamos cambiar tu contrasna .</p>
        </div>
        <div class='footer'>

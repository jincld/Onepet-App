...
import jonathan.orellana.onepetapp.login
        ...
        holder.btnBorrarCard.setOnClickListener() {
            ...
            fun update(nombreNuevo: String, correoNuevo: String, ContraNueva: String) {
                ...
                GlobalScope.launch(Dispatchers.IO) {
                    ...
                    updateVet.setString(4, iniciarsesion.uuidRol)
                ...
                fun eliminarDatos(NombreEmp: String, position: Int) {
                    ...
                    GlobalScope.launch(Dispatchers.IO) {
                        ...
                        val borrarEmp =
                            objConexion?.prepareStatement("delete from tbUsuariosOne where nombre_usuario = ?")!!

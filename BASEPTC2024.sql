...
into tbMascotas(uuid_mascota, nombre_mascota, raza, sexo, procesos_previos, alergias, enfermedades_cronicas, fecha_nacimiento, peso, foto_perfil, especie, dueno) values(SYS_GUID(), 'Mamon', 'Siames', 'Masculino', 'Removición de tumor','Chocolate','Hipertensión', '2007-01-23' , 8.5, null, (Select uuid_especie from tbEspecies where nombre_especie = 'Canino'),(Select uuid_usuario from tbUsuariosOne where nombre_usuario = 'Diego Dimas') )
select * from dual;                                       
